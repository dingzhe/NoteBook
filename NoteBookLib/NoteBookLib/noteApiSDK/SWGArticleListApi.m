...
@implementation SWGArticleListApi

/*!
 * 得到文章列表
 * 得到文章列表
 * \param body 
 * \returns SWGArticleList*
 */
-(NSNumber*) getArticleListWithBody: (SWGGetArticleByIdRequest*) body
    ...
    NSAssert(body != nil, @"Missing the required parameter `body` when calling getArticleList");
    

    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/articlelist", self.basePath];
    ...
    return [self.apiClient executeWithPath: requestUrl
                       ...
                       responseContentType: responseContentType
                           completionBlock: ^(NSDictionary *data, NSError *error) {
                             ...
                             SWGArticleList* result = nil;
                             if (data) {
                                 result = [[SWGArticleList  alloc]  initWithDictionary:data error:nil];
                             }

...
@implementation SWGAllArticleApi
...
-(NSNumber*) getAllArticleWithBody: (SWGGetArticleByIdRequest*) body
    ...
    NSAssert(body != nil, @"Missing the required parameter `body` when calling getAllArticle");
    

    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/allarticle", self.basePath];

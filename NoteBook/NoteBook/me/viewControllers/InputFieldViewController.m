...
- (void)viewDidLoad {
    ...
    self.editTextField = [[UITextField alloc]initWithFrame:CGRectMake(24, 20,self.view.frame.size.width-48, 40)];
    _editTextField.layer.borderColor = [UIColor lightGrayColor].CGColor;
    _editTextField.layer.borderWidth = 1.f;
    _editTextField.layer.cornerRadius = _editTextField.bounds.size.height/2;
    _editTextField.clearsOnBeginEditing = NO;
    _editTextField.borderStyle = UITextBorderStyleNone;
    UIView *leftview = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 10, _editTextField.frame.size.height)];
    ...
    _editTextField.placeholder = (_placeHolderText == nil)?@"":_placeHolderText;

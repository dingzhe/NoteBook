...
@implementation SWGAddArticleApi
...
-(NSNumber*) addArticleWithBody: (SWGArticle*) body
    ...
    NSAssert(body != nil, @"Missing the required parameter `body` when calling addArticle");
    

    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/addarticle", self.basePath];

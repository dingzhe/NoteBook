...
-(NSNumber*) makeUrlWithBody: (SWGGetArticleByIdRequest*) body
    ...
    NSAssert(body != nil, @"Missing the required parameter `body` when calling makeUrl");
    

    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/makeurl", self.basePath];

...
@implementation SWGUpdateArticleApi

/*!
 * 修改文章
 * 修改文章
 * \param body 
 * \returns SWGUpdateArticleResponses*
 */
-(NSNumber*) updateArticleWithBody: (SWGArticle*) body
    ...
    NSAssert(body != nil, @"Missing the required parameter `body` when calling updateArticle");
    

    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/updatearticle", self.basePath];
    ...
    return [self.apiClient executeWithPath: requestUrl
                       ...
                       responseContentType: responseContentType
                           completionBlock: ^(NSDictionary *data, NSError *error) {
                             ...
                             SWGUpdateArticleResponses* result = nil;
                             if (data) {
                                 result = [[SWGUpdateArticleResponses  alloc]  initWithDictionary:data error:nil];
                             }

...
@implementation WeeklyListCellViewModel
@dynamic model;
...
- (void) layout {
    ...
    _authorNameFrame = CGRectMake(self.cellWidth - cOuterInset.right - authorNameSize.width , CGRectGetMinY(_titleNameFrame) + (titleNameSize.height - authorNameSize.height), authorNameSize.width, authorNameSize.height);
    ...
    _updateTimeFrame = CGRectMake(_titleNameFrame.origin.x, _titleNameFrame.origin.y + titleNameSize.height + 25, updateTimeSize.width, updateTimeSize.height);
    self.cellHeight =CGRectGetMaxY(_updateTimeFrame)  + cOuterInset.bottom;
//    self.cellHeight = 80;
